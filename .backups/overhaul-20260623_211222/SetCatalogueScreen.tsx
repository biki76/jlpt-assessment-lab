    ...
    <div className="min-h-screen bg-dark-900 text-white">
      ...
      <header className="sticky top-0 z-40 bg-dark-900/95 backdrop-blur border-b border-dark-700">
        <div className="max-w-lg mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <span className="text-xs text-text-tertiary">JLPT Practice</span>
        </div>
      </header>
      ...
      <main className="max-w-lg mx-auto px-4 py-4 pb-24">
        ...
        {!loading && !error && sets.length === 0 && (
          <div className="mt-16 text-center">
            <p className="text-text-tertiary text-lg">No practice sets available for this level yet.</p>
            ...
            {sets.map((set) => (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-text-tertiary">{set.question_count} questions</span>
                </div>
